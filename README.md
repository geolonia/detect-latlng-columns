# @geolonia/detect-latlng-columns

CSV / Excel の**ヘッダー名から緯度・経度カラムを判定・検出する**依存ゼロの純粋関数。
...
{
  "dependencies": {
    "@geolonia/detect-latlng-columns": "github:geolonia/detect-latlng-columns#v0.1.0"
  }
}
```
...
```ts
import { findLatLngColumns } from "@geolonia/detect-latlng-columns";
